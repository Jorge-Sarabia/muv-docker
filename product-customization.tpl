          ...
          <ul class="clearfix">
            {foreach from=$customizations.fields item="field"}
              <li class="product-customization-item">
                {if $field.label == '_as_name_'}
                  <label for="field-{$field.input_name}">Nombre del Asegurado</label>
                  <input type="email" placeholder="{l s='Escriba el nombre del asegurado' d='Shop.Forms.Help'}" class="product-message" maxlength="250" {if $field.required} required {/if} name="{$field.input_name}" id="field-{$field.input_name}"></input>
                  ...
                  {/if}
                {elseif $field.label == '_as_tel_'}
                  <label for="field-{$field.input_name}">Teléfono del Asegurado</label>
                  <input type="tel" pattern="[0-9]{10}" placeholder="{l s='Escriba el teléfono del asegurado' d='Shop.Forms.Help'}" class="product-message" maxlength="10" {if $field.required} required {/if} name="{$field.input_name}" id="field-{$field.input_name}"></input>
                  <small class="float-xs-right">{l s='10 char. max' d='Shop.Forms.Help'}</small>
                  {if $field.text !== ''}
                      <h6 class="customization-message">{l s='Your customization:' d='Shop.Theme.Catalog'}
                          <label>{$field.text}</label>
                      </h6>
                ...
                {elseif $field.type == 'text'}
                  <input type="tel" placeholder="{l s='Your message here' d='Shop.Forms.Help'}" class="product-message" maxlength="250" {if $field.required} required {/if} name="{$field.input_name}" id="field-{$field.input_name}"></input>
                  <small class="float-xs-right">{l s='250 char. max' d='Shop.Forms.Help'}</small>
                  {if $field.text !== ''}
                      <h6 class="customization-message">{l s='Your customization:' d='Shop.Theme.Catalog'}
                          <label>{$field.text}</label>
